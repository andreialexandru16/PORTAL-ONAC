...
import ro.bithat.dms.smartform.gui.attribute.binder.IbanAttributeValidator;
...
@SpringComponent
@UIScope
public class IbanAttributeLinkComponent extends AttributeLinkGenericComponent {
    @Override
    public boolean canPostProcess(AttributeLink attributeLink) {
        return SmartFormSupport.getAttributeLinkDataType(attributeLink).equals(AttributeLinkDataType.IBAN);
    }
