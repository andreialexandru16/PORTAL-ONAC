...
@Route(value = "solicitare-noua-atasamente")
@PageTitle(" Atașamente Solicitare")
public class Ps4ECitizenServiceAttacheFileRoute extends DocumentTypeRoute {


    @FlowComponent
    private Ps4ECitizenServiceAttacheFileView serviceAttacheFileView;
