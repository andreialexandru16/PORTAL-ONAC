...
@Route(value = "inregistrare")
@PageTitle(" Înregistrare")

public class Ps4ECitizenUserRegisterRoute extends Ps4ECitizenPortalRoute {
    ...
    @FlowComponent
    private Ps4ECitizenUserRegisterView userRegisterView;
    ...
    protected boolean buildPortalRoute() {
        ...
        breadcrumbView.setCurrentPageTitle("ps4.ecetatean.breadcrumb.user.register.page.title");
        addContentContainer(userRegisterView);
        return true;
    }
