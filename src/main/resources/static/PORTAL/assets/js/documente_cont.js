...
var FileManager = {
    ...
    loadFormulareData: function () {
        ...
        var defer = $.Deferred();
        var url= that.wsAndUserInfo.wsUrl + '/document/' + that.wsAndUserInfo.userToken.token + '/getDocumentListByCont';
        $.ajax({
            url: url,
            type: 'GET',
            ...
            success: function (data) {
                if (data.result == 'OK') {
                    ...
                    that.renderTemplateData(data,'#container_doc_gn','tmpl_formulare_list_gn');
                    $('.dataTable_gn').DataTable( {
                        "searching": true,
                        language: {
                            info:           "Se afișează _START_ - _END_ din _TOTAL_ intrări",
                            infoEmpty:      "Se afișează 0 - 0 din 0 intrări",
                ...
                that.renderTemplateData(data,'#container_doc_ee','tmpl_formulare_list_ee');
                    $('.dataTable_ee').DataTable( {
                    "searching": true,
                        language: {
                        info:           "Se afișează _START_ - _END_ din _TOTAL_ intrări",
                            infoEmpty:      "Se afișează 0 - 0 din 0 intrări",
                ...
                that.renderTemplateData(data,'#container_doc_et','tmpl_formulare_list_et');
                $('.dataTable_et').DataTable( {
                "searching": true,
                    language: {
                    info:           "Se afișează _START_ - _END_ din _TOTAL_ intrări",
                        infoEmpty:      "Se afișează 0 - 0 din 0 intrări",
