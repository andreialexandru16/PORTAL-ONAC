...
import ro.bithat.dms.smartform.gui.attribute.binder.LocalDateAttributeBinderBean;
...
@SpringComponent
@UIScope
public class DatePickerAttributeLinkComponent extends AttributeLinkGenericComponent {
    @Override
    public boolean canPostProcess(AttributeLink attributeLink) {
        return SmartFormSupport.getAttributeLinkDataType(attributeLink).equals(AttributeLinkDataType.DATA);
    }
