...
@Route(value = "resetare-parola")
public class Ps4ECitizenUserAccountRecoveryRoute extends Ps4ECitizenPortalRoute {
    ...
    protected boolean buildPortalRoute() {
        ...
        breadcrumbView.setCurrentPageTitle("ps4.ecetatean.breadcrumb.user.passswordreset.page.title");
        return true;
    }
