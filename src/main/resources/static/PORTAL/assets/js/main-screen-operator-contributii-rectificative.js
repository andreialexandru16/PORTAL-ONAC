...
var FileManager = {
    ...
    openFormular: function (idTipDoc,idClasaDoc, request,jspPage, status) {

        if(  request=='false'){
            Swal.fire({
                position: 'center',
                icon: 'info',
                html: "Perioada selectata este inchisa raportarii!",
                focusConfirm: false,
                confirmButtonText: 'Ok'
            });
        }
        else if( status.toUpperCase()=='IN ASTEPTARE'){
            var url=jspPage;
            ...
            Swal.fire({
                position: 'center',
                icon: 'info',
                html: "Raportarea nu mai poate fi modificata!",
                focusConfirm: false,
                confirmButtonText: 'Ok'
            });
        }
...
//user is "finished typing," do something
    ...
    loadPerioadaData: function () {
        ...
        var req = {
            "zona": "CONTRIBUTII_RECTIFICATIVE"
        };
