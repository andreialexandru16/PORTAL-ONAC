...
@Route(value = "contact")
@PageTitle(" Contact")
public class Ps4ECitizenContactRoute extends Ps4ECitizenPortalRoute {
    ...
    @FlowComponent
    private Ps4ECitizenContactView contactView;
    ...
    protected boolean buildPortalRoute() {
        ...
        breadcrumbView.setCurrentPageTitle(I18NProviderStatic.getTranslation("ps4.ecetatean.breadcrumb.contact.title"));
        addContent(contactView);
        return true;
    }
