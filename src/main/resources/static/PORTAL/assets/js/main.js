...
function swalInfoBottomError(infoText, callback) {
...
function swalInfoBottomThenClose(infoText, callback) {
...
function swalErrorBottom(errorText, callback) {
    Swal.fire({
...
function swalInfoParam2Top(infoText, callback,param) {
...
function swalInfoWithoutBtn(infoText, callback) {
    window.parent.parent.scrollTo(0, 0);
...
function swalInfoMessage(infoText, callback) {
    ...
    Swal.fire({
        ...
        cancelButtonText: `Nu, vreau sa completez!`,
        ...
        if (result.value) {
        callback.$server.confirmInfoAck();
    } else if(result.dismiss=='cancel') {
        callback.$server.rejectInfoAck();
    }
