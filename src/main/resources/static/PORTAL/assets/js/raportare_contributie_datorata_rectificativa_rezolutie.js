 ...
 */
    ...
    rulareRaportareGarantare : function (idFisier, download) {
        ...
        var url = that.wsAndUserInfo.wsUrl + '/jasper/' + that.wsAndUserInfo.userToken.token +'/rulareRaportareJasperByTipDoc/'+idFisier+'?&codtipdoc=RAPORTARE_RECTIFICARE_RZ';
        $.ajax({
            url: url,
            method: 'PUT',
            ...
            onSuccess: function (data) {
                if (data.result == 'OK') {
                    ...
                    $('table').each(function() {
                        ...
                        '?&codTipDocInitial=RAP_CONTR_DAT_VIR_FGA_REZ';
                        that.ajaxAction({
                            url: urlTabel,
                            method: 'POST',
                            headers: that.mergeObjects(that.corsHeaders, {
    ...
    getInfoTabelRaport:function(){
        ...
        $.ajax({
            url: '/dmsws/formular_custom/getInfoRaportRectificareRez/' +that.idPerioada,
            success: function (data) {
                if (data.result == 'OK') {
