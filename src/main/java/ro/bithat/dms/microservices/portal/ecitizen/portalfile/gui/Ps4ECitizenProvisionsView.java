...
public class Ps4ECitizenProvisionsView extends DivFlowViewBuilder<Ps4ECitizenProvisionsPresenter> {
    ...
    private void setPortalFileTableRow(PortalFile document) {
        ...
        if (document.getDownloadLink() != null) {
            ...
            downloadLink.add(iconDownload, new Text(I18NProviderStatic.getTranslation("portalfile.view.file.download.label")));
    ...
    public void setTableHeaders() {
        ...
        serviceDocumentsTable.addHeader("portalfile.view.file.meetingdate.label", "text-nowrap hcl_date text-center");
        serviceDocumentsTable.addHeader("portalfile.view.file.download.label", "text-nowrap hcl_download text-center");
