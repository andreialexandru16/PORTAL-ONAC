...
public class Ps4ECorespondentaControlView extends ContentContainerView<Ps4ECorespondentaControlPresenter>   {
    ...
    public void beforeBinding() {
        ...
        setContentPageTile(I18NProviderStatic.getTranslation("ps4.ecetatean.breadcrumb.corespondentaControl.title"));
    ...
    public void setMyRequestsTable(List<CorespondentaControl> myDocuments) {
    ...
    private void setDocumentTableRow(CorespondentaControl document, AtomicInteger index) {
        Strong strongElementContent= new Strong();

        if (document.getCorespondentaLinieControlList() != null){
            for (CorespondentaLinieControl cl: document.getCorespondentaLinieControlList()){
