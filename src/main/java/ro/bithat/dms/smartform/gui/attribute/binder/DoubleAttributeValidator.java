...
public class DoubleAttributeValidator extends RegexpValidator {
...
//22.06.2021 - Neata Georgiana - ANRE - modificat regex pentru acceptare numar negativ
    ...
    public DoubleAttributeValidator(String errorMessage,  Integer precision) {
        super(errorMessage, "-?+(\\d?)+(\\.\\d{1,"+precision+"})?", true);
    }
    public DoubleAttributeValidator(String errorMessage) {
