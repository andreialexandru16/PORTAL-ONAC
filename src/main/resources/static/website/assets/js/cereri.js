...
var PageManager = {
    ...
    getListaInregistrari: function () {
        ...
        var that = this;
        var PROC_NAME = "PageManager.getCereriList";
        $UTIL.log(PAGE_NAME, PROC_NAME, 'Enter', 0);

        var url = this.wsUrl+"/document/"+this.wsToken+"/getCereriList";
    ...
    buildPagination: function () {
        ...
        var url = this.wsUrl+'/document/'+this.wsToken+'/getCereriListCount';
        $.ajax({
            url: url,
