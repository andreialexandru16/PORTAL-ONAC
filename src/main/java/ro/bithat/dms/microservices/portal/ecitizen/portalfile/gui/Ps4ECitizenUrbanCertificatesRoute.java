...
@Route(value = "certificate-urbanism")
@PageTitle("PORTAL - Certificate de urbanism emise")

public class Ps4ECitizenUrbanCertificatesRoute extends Ps4ECitizenPortalRoute {
    ...
    @FlowComponent
    private Ps4ECitizenUrbanCertificatesView portalFileView;
    ...
    protected boolean buildPortalRoute() {
        ...
        breadcrumbView.setCurrentPageTitle("ps4.ecetatean.breadcrumb.portalfile.urban.certificates.page.title");
