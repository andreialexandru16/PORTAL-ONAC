...
public class Ps4ECitizenBuildingAuthorizationsView extends DivFlowViewBuilder<Ps4ECitizenBuildingAuthorizationsPresenter> {
    ...
    public void buildView() {
        ...
        newProjectBtn.setValue(I18NProviderStatic.getTranslation("ps4.ecetatean.breadcrumb.portalfile.building.authorizations.add.btn"));
    ...
    public void setTableHeaders() {
        serviceDocumentsTable.addHeader("ps4.ecetatean.breadcrumb.portalfile.building.authorizations.nr", "text-nowrap");
        serviceDocumentsTable.addHeader("ps4.ecetatean.breadcrumb.portalfile.building.authorizations.address", "text-nowrap");
        serviceDocumentsTable.addHeader("ps4.ecetatean.breadcrumb.portalfile.building.authorizations.requester", "text-nowrap");
        serviceDocumentsTable.addHeader("ps4.ecetatean.breadcrumb.portalfile.building.authorizations.type", "text-nowrap");
        serviceDocumentsTable.addHeader("ps4.ecetatean.breadcrumb.portalfile.building.authorizations.map", "text-nowrap");
