...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20211102_anre_ee249f91b36cae434128_20211102091719_archive.zip';
    const ARCHIVE_SIZE       = '71390306';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = 'ee249f9-02091719';
    const SECONDARY_PACKAGE_HASH = '83b189c-02091719';
    ...
    public function run()
    {
        ...
        $this->log('==DUPLICATOR INSTALLER BOOTSTRAP v4.0.3.2==');
        $this->log('----------------------------------------------------');
