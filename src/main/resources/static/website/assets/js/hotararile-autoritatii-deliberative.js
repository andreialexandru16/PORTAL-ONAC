...
var PAGE_NAME = "dispozitii-autoritate-executiva.js";
...
var PageManager = {
    ...
    getListaInregistrari: function (jReq) {
        ...
        var url =$UTIL.WS_URL+"/registratura_portal/"+this.wsToken+"/getInregistrariList/"+that.idRegistru;
    ...
    getCriteriiCautare: function () {
        ...
        var url =$UTIL.WS_URL+"/registratura_portal/"+this.wsToken+"/getCriteriiCautare/"+that.idRegistru;
    ...
    buildPagination: function () {
        ...
        var url =$UTIL.WS_URL+"/registratura_portal/"+this.wsToken+"/getInregistrariListCount/"+that.idRegistru;
    ...
    buildPaginationCautare: function (searchStr) {
        ...
        var defer = $.Deferred();
        var nrTotalInregistrari = 0;
        var url =$UTIL.WS_URL+"/registratura_portal/"+this.wsToken+"/getInregistrariListCautareCountP/"+that.idRegistru;
        ...
        var listaCriterii=PageManager.myDrop.selectedValues();
        ...
        $.ajax({
            ...
            success: function (json) {
                ...
                if (json && json.info != null) {
                    nrTotalInregistrari = parseInt(json.info);
                }
    ...
    getListaInregistrariCautare: function (searchStr) {
        ...
        var url =$UTIL.WS_URL+"/registratura_portal/"+this.wsToken+"/getInregistrariListCautareP/"+that.idRegistru;
        ...
        var listaCriteriiSelectate=PageManager.myDrop.selectedValues();
        var jReq=JSON.stringify(listaCriteriiSelectate);
        console.log("Ajax Call Start:" + url);
        var listaCriterii=PageManager.myDrop.selectedValues();
        var jReq=JSON.stringify(listaCriterii);
        $.ajax({
    ...
    mandatoryFunctions: function () {
        ...
        PageManager.idRegistru = $UTIL.idRegistruHCJ;
