...
var FileManager = {
    ...
    openFormular: function (idTipDoc,idClasaDoc, request) {
            ...
            if(  request!='false'){
                var url='/PISC/solicitare-noua?document='+idTipDoc+'&tipDocument='+idClasaDoc+'&fromMainScreen=EE'+request;
    ...
    viewFormular: function (idTipDoc,idClasaDoc, request) {
        ...
        if(  request!='false'){
            var url='/PISC/solicitare-revizie-finala?document='+idTipDoc+'&tipDocument='+idClasaDoc+'&fromMainScreen=EE-VIEW'+request;
            var idPerioada= $("#select_perioada").val();
            if(idPerioada!=null && typeof idPerioada !='undefined' && idPerioada!=''){
                url+='&idPerioada='+idPerioada;
