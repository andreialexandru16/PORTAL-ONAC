...
var PAGE_NAME = "go-get-VAADIN.js";
                         ...
                         if (that.isNotUndef(res) && that.isNotEmpty(res) && res === "redir") {
                             if(that.isNotUndef(that.checkAuth) && that.isNotEmpty(that.checkAuth) && that.checkAuth === "true"){
                                     ...
                                     success: function (data) {
                                         ...
                                         if(isLogged){
                                             ...
                                             if(that.targetPage.includes('schimbare-parola')){
                                                 ...
                                                 $("#iframePage").attr('src', $UTIL.PORTAL_URL+that.targetPage+'&idUser='+$UTIL.loadUserDataFromSession().userId+'&token='+$UTIL.loadUserDataFromSession().token);
                                                 swal.close();
                                             }
                                         }
                                         else{
                                 ...
                                 if(that.targetPage.includes('schimbare-parola')){
                                     ...
                                     $("#iframePage").attr('src', $UTIL.PORTAL_URL+that.targetPage);
                                     swal.close();
