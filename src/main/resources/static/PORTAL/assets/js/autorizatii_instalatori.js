...
var PageManager = {
    ...
    codTipAutorizatie: "LOV_GRAD_AUTORIZATIE_GN_LP",
    codTiparita: "LOV_TIPARIRE_AUTORIZATIE_GN_LP",
    ...
    loadLovTiparita: function() {
        var that = this;
        var url = "/dmsws/lov/values_by_code/" + PageManager.codTiparita;
        $.ajax({
            url: url,
            success: function (data) {
                if (data.result == 'OK') {
                    ...
                    if (data.lov != null && data.lov.length != 0) {
                        var lov = data.lov;
                        $('#stare_tiparire').append(that.getOptionListItemHtml('0', 'Selecteaza stare tiparire'));
                        for(i=0;i<lov.length;i++){
    ...
    getListaInregistrari: function (jReq) {
        ...
        var url ="/dmsws/anre/getAutorizatiiInstalatori";
    ...
    buildPagination: function () {
        ...
        var url ="/dmsws/anre/getAutorizatiiInstalatoriCount/";
