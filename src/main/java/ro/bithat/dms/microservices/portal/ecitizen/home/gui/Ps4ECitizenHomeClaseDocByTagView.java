...
public class Ps4ECitizenHomeClaseDocByTagView extends DivFlowViewBuilder<Ps4ECitizenHomeClaseDocByTagPresenter> {
    ...
    private Div mainDiv= new Div(categoriesContainer);
