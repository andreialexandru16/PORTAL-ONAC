...
@Route(value = "contul-meu-detalii")
@PageTitle(" Detalii Contul Meu")

public class Ps4ECitizenAccountDetailRoute extends Ps4ECitizenPortalRoute {
    @FlowComponent
    private BreadcrumbView breadcrumbView;

    @FlowComponent
    private Ps4ECitizenAccountDetailView accountDetailView;
...
*/
        ...
        breadcrumbView.setCurrentPageTitle("ps4.ecetatean.breadcrumb.myaccount.detail.page.title");
        addContentContainer(accountDetailView);
        return true;
    }
}
