...
@Route(value = "contul-meu-inbox")
@PageTitle(" Inbox")

public class Ps4ECitizenEmailInboxRoute extends Ps4ECitizenPortalRoute {

    @FlowComponent
    private BreadcrumbView breadcrumbView;

    @FlowComponent
    private Ps4ECitizenEmailInboxView emailInboxView;
...
*/
        ...
        breadcrumbView.setCurrentPageTitle("ps4.ecetatean.breadcrumb.myaccount.page.inbox.title");
        addContentContainer(emailInboxView);
        return true;
    }
}
