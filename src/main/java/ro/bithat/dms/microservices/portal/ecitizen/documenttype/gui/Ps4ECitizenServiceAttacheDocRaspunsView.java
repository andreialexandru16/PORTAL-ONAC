...
import ro.bithat.dms.microservices.portal.ecitizen.documenttype.gui.component.UploadDocTableContainer;
...
public class Ps4ECitizenServiceAttacheDocRaspunsView extends ContentContainerView<Ps4ECitizenServiceAttacheDocRaspunsPresenter> implements ClientDetailsObserver, WindowResizeObserver {
    ...
    private UploadDocTableContainer serviceNeededDocumentsContainer = new UploadDocTableContainer(this);
    //Needed Document table
    ...
    public void buildBreadcrumbsWizard() {
        ...
        breadcrumbRequestWizardView.setCurrentPageActive( RouteConfiguration.forApplicationScope().getUrl(Ps4ECitizenServiceAttacheDocRaspunsRoute.class));
