...
var PageManager = {
    ...
    init: function () {
        ...
        PageManager.initLovTarife();
        PageManager.initLovSocietate();
        PageManager.initLovStareDosar();
        PageManager.initLovSesiuneExamen();
        PageManager.initLovCentruExamen();
    ...
    getListaInregistrari: function (jReq) {
        ...
        var url ="/dmsws/anre/getExameneElectricieni";
    ...
    buildPagination: function () {
        ...
        var url ="/dmsws/anre/getExameneElectricieniCount/";
    ...
    initLovTarife: function () {

        var PROC_NAME = "PageManager.initLovTarife";
        $UTIL.log(PAGE_NAME, PROC_NAME, 'Enter', 0);
        ...
        var url ="/dmsws/nomenclator/tarife_ee_n3";
    ...
    initLovStareDosar: function () {

        var PROC_NAME = "PageManager.initLovStareDosar";
        $UTIL.log(PAGE_NAME, PROC_NAME, 'Enter', 0);
        ...
        var url ="/dmsws/nomenclator/status_dosar";
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result && result.lov != null) {
                    var lov = result.lov;
                    $('#stare_dosar').append(that.getOptionListItemHtml('0', 'Selecteaza stare dosar'));
                    for(i=0;i<lov.length;i++){
    ...
    initLovSesiuneExamen: function () {

        var PROC_NAME = "PageManager.initLovSesiuneExamen";
        $UTIL.log(PAGE_NAME, PROC_NAME, 'Enter', 0);
        ...
        var url ="/dmsws/nomenclator/sesiune_examen/EE";
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result && result.lov != null) {
                    var lov = result.lov;
                    $('#sesiune').append(that.getOptionListItemHtml('0', 'Selecteaza sesiunea'));
                    for(i=0;i<lov.length;i++){
    ...
    initLovCentruExamen: function () {

        var PROC_NAME = "PageManager.initLovCentruExamen";
        $UTIL.log(PAGE_NAME, PROC_NAME, 'Enter', 0);
        ...
        var url ="/dmsws/nomenclator/centru_examen";
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result && result.lov != null) {
                    var lov = result.lov;
                    $('#centru').append(that.getOptionListItemHtml('0', 'Selecteaza centrul'));
                    for(i=0;i<lov.length;i++){
                        $('#centru').append(that.getOptionListItemHtml(lov[i].valoare, lov[i].valoare));
                    }
                }
