...
public class Ps4ECitizenMyInvoicesPresenter extends PrepareModelFlowPresenter<Ps4ECitizenMyInvoicesView> {
    ...
    public void prepareModel(String state) {
        List<PortalFile> userRequests= myRequestsService.getInvoicesByUser();
