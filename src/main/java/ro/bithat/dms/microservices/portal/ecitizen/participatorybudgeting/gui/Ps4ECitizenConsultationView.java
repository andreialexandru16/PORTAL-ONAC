...
public class Ps4ECitizenConsultationView extends DivFlowViewBuilder<Ps4ECitizenConsultationPresenter> {
    ...
    private Paragraph budgetariProjectPosition = new Paragraph();

    private Div budgetaryProjectPositionLayout = new Div(new Strong("Pozitie afisare:"), budgetariProjectPosition);
    ...
    private Div consultationForm = new Div(consultationFormRowAdminProjects,consultationFormRow1, consultationFormRow2, consultationFormRow3,
            consultationFormRow4, consultationFormRow5, consultationFormRowDescription, consultationFormRowAdmin1, consultationFormRowAdmin2,
    ...
    private Strong consultationInfoPhone2Title = new Strong("Asistență Cetățeni");
    ...
    private Paragraph consultationTabInfoParagraph = new Paragraph("Apreciem propunerile Dvs pentru noi propuneri de proiect. Completați mai jos:");
...
//        budgetMap.getStyle().set("min-height", "600px");
    ...
    public void clickMarker(JsonObject markerInfo) {
        ...
        if (getPresenter().getParticipatoryBudgetingActionForm() == Ps4ECitizenConsultationPresenter.ParticipatoryBudgetingActionForm.BUDGETING) {
        ...
        poiPopup.showPopUp(poiId, markerInfo.getString("categoriePoi"),
                JreJsonNull.class.isAssignableFrom(markerInfo.get("denumire").getClass()) ? "" : markerInfo.getString("denumire"),
        ...
        if (getPresenter().getParticipatoryBudgetingActionForm() == Ps4ECitizenConsultationPresenter.ParticipatoryBudgetingActionForm.ADMIN) {
...
//        toggleSideBar.addClickListener(e -> )
        ...
        configPanelHeaderTabButton(budgetaryTabBtn, "consultare", "fa-user-friends", false, "Votează proiect");
        configBudgetaryTab();
        consultationTabBtn.addClickListener(e -> displayConsultationTab());
        configPanelHeaderTabButton(consultationTabBtn, "bugetare", "fa-coins", true, "Consultare Cetățeni");
    ...
    protected void displayConsultationTab() {
        ...
        getPresenter().setParticipatoryBudgetingActionForm(Ps4ECitizenConsultationPresenter.ParticipatoryBudgetingActionForm.CONSULTATION);
    ...
    public void displayPoiAdmin() {
       ...
       */
       /*consultationFormRowAdmin1.getStyle().remove("display");
        ...
        getPresenter().setParticipatoryBudgetingActionForm(Ps4ECitizenConsultationPresenter.ParticipatoryBudgetingActionForm.ADMIN);
    }
    public void displayPoiConsultare() {
        displayConsultationTab();
        budgetaryTab.setVisible(false);
        budgetaryTabBtn.setVisible(false);
        consultationFormDraft.setValue(false);
        getPresenter().setParticipatoryBudgetingActionForm(Ps4ECitizenConsultationPresenter.ParticipatoryBudgetingActionForm.ADMIN);
    ...
    protected void displayBudgetaryTab() {
        ...
        getPresenter().setParticipatoryBudgetingActionForm(Ps4ECitizenConsultationPresenter.ParticipatoryBudgetingActionForm.BUDGETING);
    }
    ...
    private void configConsultationFormActionControls() {
        ...
        consultationSendBtn.add(new Span("Salvează"), constructConsultationFormActionBtnIco());
        consultationSendBtn.setVisible(false);
    ...
    private void configConsultationFormCustomControl() {
        ...
        termsAndConditionPagesLink.setText("termenii și condițiile");
...
//        DomEventViewSupport.registerUploadSucceededEvent(this, "uploadFile", chunkUpload, );
    ...
    private void configConsultationFormRowDurata() {
        ...
        consultationFormDurataValue.setPlaceholder("Durată proiect ");
...
//        budgetaryTabBtn.getStyle().remove("display");
        ...
        try{
            budgetariProjectPosition.setText(poiInfo.getString("info1"));
        }catch (Exception e){
        ...
        try{
            String val =BigDecimal.valueOf(poiInfo.getNumber("valoare")).toPlainString();
            budgetaryProjectValue.setText(val + " LEI");
        }catch (Exception e) {
    ...
    public void configAdminForm(ProjectInfo poiInfo, List<CategoriePOI> categories, List<StatusProiect> stages) {
        ...
        if (Optional.ofNullable(poiInfo.getValoare()).isPresent()) {
            consultationFormValue.setValue(BigDecimal.valueOf(poiInfo.getValoare()).toPlainString() + "");
        }
