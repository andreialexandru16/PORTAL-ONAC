var PAGE_NAME = "raportare_contributie_rezolutie.js";
...
//1. Recalculare Suma virata
    ...
    rulareRaportareGarantare : function (idFisier, download) {
        ...
        var url = that.wsAndUserInfo.wsUrl + '/jasper/' + that.wsAndUserInfo.userToken.token +'/rulareRaportareJasperByTipDoc/'+idFisier+'?&codtipdoc=RAPORTARE_REZOLUTIE';
        $.ajax({
            url: url,
            method: 'PUT',
    ...
    checkCampuriObligatorii:function(){
        ...
        if(idPerioada===null || idPerioada==="" || idPerioada===undefined) {
            ...
            Swal.fire({
                position: 'top',
                icon: 'error',
                html: "Va rog completati campurile cu '*'!<br/>",
                focusConfirm: false,
                confirmButtonText: 'Ok'
            });
            ...
            Swal.fire({
                position: 'top',
                icon: 'error',
                html: "Va rog completati numarul si data documentului din zona 6,7!<br/>",
                focusConfirm: false,
                confirmButtonText: 'Ok'
            });
        }else{
    ...
    checkPerioada:function(){
        ...
        if(idPerioada=="" || idPerioada==null){
            ...
            $.ajax({
            url: '/dmsws/formular_custom/checkPerioadaRaportareRez/'+idPerioada,
            success: function (data) {
                if (data.result == 'OK') {
    ...
    getInfoTabelRaport:function(){
        ...
        var that=this;
        var params="";
        var params="?&codTipDoc=RAP_CONTR_DAT_VIR_FGA_REZ";
